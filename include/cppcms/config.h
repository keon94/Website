...
/* "Have g++ typeof" */
/* #undef CPPCMS_HAVE_UNDERSCORE_TYPEOF */

/* Define to the full name of this package. */
#define CPPCMS_PACKAGE_NAME "CppCMS"

/* Define to the full name and version of this package. */
#define CPPCMS_PACKAGE_STRING "CppCMS/1.2.0"

/* Define to the version of this package. */
#define CPPCMS_PACKAGE_VERSION "1.2.0"

/* Define to module suffix. */
#define CPPCMS_LIBRARY_SUFFIX ".dll"

/* Define to module suffix. */
/* #undef CPPCMS_LIBRARY_PREFIX */
...
/* #undef CPPCMS_HAS_THREAD_PSHARED */
#define CPPCMS_HAVE_FSEEKI64
/* #undef CPPCMS_HAVE_FSEEKO */
